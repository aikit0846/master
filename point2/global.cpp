...
const std::string DIR = "/home/suzuki/master/point2/";
...
void Link::CalcRailLinkCost(std::function<double(double, double)> RailLinkCostFunc)
{
    if (this->type == 'r') {
...
void Link::CalcRailLinkCostPrime(std::function<double(double, double)> LinkCostFuncPrime)
{
    if (this->type == 'r') {
