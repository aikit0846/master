...
# ## 流線図の描画
make_phase_diagram('stream.csv', 'streamVec.csv', 'contour.csv', 'contourObj.csv', 'flowDiagram.png', ['0', '1', '2'], scale=1, cnum=30, minscale=0.15, mode=False, arrowpos=[1, 10, 30])
