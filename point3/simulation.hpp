...
// With Pointでシミュレーション
void Simulation(std::vector<Path> &pathVec, std::vector<Link> &linkVec, std::vector<Node> nodeVec, std::vector<Demand> &demandVec, std::function<double(double, double)> RailLinkCostFunc, std::function<double(double, double)> RailLinkCostFuncPrime, std::function<double(double, double)> StayLinkCostFunc, std::function<double(double, double)> StayLinkCostFunc2, std::vector<double> &sumCostTrans, std::vector<double> &railCostTrans, std::vector<double> &stayUtilTrans, std::vector<std::vector<double>> &pathCostTrans, std::vector<std::vector<double>> &possessedPointTrans, std::vector<std::vector<double>> &linkFlowTrans, std::vector<std::vector<double>> &zeroFlowTrans, std::vector<std::vector<double>> &oneFlowTrans, std::vector<std::vector<double>> &pathFlow, std::vector<std::vector<double>> &moneyTrans, std::vector<std::vector<double>> &pointTrans, std::vector<double> &railRevenueTrans, std::vector<double> &storeRevenueTrans, std::vector<std::vector<double>> &perturbationTrans, std::vector<std::vector<double>> &pathZeroCostTrans, std::vector<std::vector<double>> &pathOneCostTrans);
